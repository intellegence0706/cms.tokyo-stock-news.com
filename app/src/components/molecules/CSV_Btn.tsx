...
const CSV_Btn = ({ className, onImport, onExport }: Props) => {
    const handleImport = () => {
        if (onImport) {
            onImport();
        }
    ...
    return (
        <Dropdown>
            <MenuButton>Excel管理</MenuButton>
            <Menu slots={{ listbox: AnimatedListbox }}>
                <MenuItem onClick={handleImport}>一括登録</MenuItem>
                <MenuItem onClick={handleExport}>ダウンロード</MenuItem>
            </Menu>
        </Dropdown>
    );
};

export default CSV_Btn;

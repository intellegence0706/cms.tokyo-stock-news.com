...
import { setCurrentItemValue } from '@/store/features/loginSlice';
import { appendMessage } from '@/store/features/utilSlice';
...
const SignInPage = () => {
    ...
    const currentItem = useAppSelector(state => state.loginReducer.item.form);
    const errors = useAppSelector(state => state.loginReducer.item.errors);
